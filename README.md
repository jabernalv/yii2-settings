...
```
php composer.phar require --prefer-dist jabernal/yii2-settings "*"
```

or add

```
"jabernal/yii2-settings": "*"
```
...
```php
./yii migrate/up --migrationPath=@vendor/jabernal/yii2-settings/migrations
```
...
'modules' => [
    'settings' => [
        'class' => 'jabernal\settings\Module',
        'sourceLanguage' => 'en'
    ],
    ...
],
...
'components' => [
    'settings' => [
        'class' => 'jabernal\settings\components\Settings'
    ],
    ...
]
```
...
3. Add `jabernal\settings\SettingsAction` to the controller's actions.
...
function actions(){
   return [
   		//....
            'site-settings' => [
                'class' => 'jabernal\settings\SettingsAction',
